...
public class PlayerRB extends Player {
    ...
    public PlayerRB(String nm, int yr, int stars, Team t) {
        ...
        ratCatch = (int) ((ratBase - 10) + year * yearFactor + stars * starFactor - ratTolerance * Math.random());
        ratOvr = getOverall();
    ...
    public PlayerRB(String nm, int yr, int stars, Team t, boolean custom) {
        ...
        ratCatch = (int) ((ratBase - 10) + stars * customFactor - ratTolerance * Math.random());
        ratOvr = getOverall();
        region = (int) (Math.random() * 5);
        personality = (int) (attrBase + 50 * Math.random());
    ...
    public int getHeismanScore() {
        return statsRushTD * 150 - statsFumbles * 75 + (int) (statsRushYards * 3.25) + 2 * statsReceptions + (int) (statsRecYards * 2.65) + statsRecTD * 150 + statsKickRetYards + statsKickRetTDs * 150 + statsPuntRetYards + statsPuntRetTDs * 150 + ratOvr * 10 + getConfPrestigeBonus();
    }
